    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#services" className="text-sm text-secondary hover:text-primary transition-colors">
            Services
          </a>
          <a href="#cas-clients" className="text-sm text-secondary hover:text-primary transition-colors">
            Cas clients
          </a>
          <a href="#blog" className="text-sm text-secondary hover:text-primary transition-colors">
            Blog
          </a>
          <a href="#tarifs" className="text-sm text-secondary hover:text-primary transition-colors">
            Tarifs
          </a>
          <a
            href="#audit"
            className="bg-primary text-white text-sm font-semibold px-4 py-2 rounded-md hover:bg-primary/90 transition-colors"
          >
            Audit gratuit →
          </a>
        </div>
